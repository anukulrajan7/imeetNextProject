...
const Hero = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white">
      <div className="flex items-center gap-4  rounded-md px-4 justify-between bg-white  lg:w-[80%] py-20 flex-col md:flex-row">
      <div className='lg:w-[70%] md:w-[60%] w-full flex flex-col item-start px-4 flex-wrap gap-5'>
  ...
  <br /><span className='text-purple-700'> skills with iMeet's internship programs! 🎯 Work on real-world projects, <br /> collaborate with a talented team, and receive guidance from experienced mentors. 💡 By the end of the program, you'll have the confidence to take on exciting challenges in the tech industry. Join us today and embark on a transformative journey to unlock endless possibilities! </span>✨👩‍💻👨‍💻
</p>

        </div>
      <div className="w-fit px-7 py-4 shadow-md rounded-md">
